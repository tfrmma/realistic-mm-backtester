...
class ProBacktestEngine:
    ...
    Tick flow:
      ...
      2. FIFO queue processes tick -> fills
      3. Strategy on_tick (TODO: delay book by feed_us, need ring buffer)
    ...
    def _step(self, state: _StratState, tick: MarketTick) -> None:
        ...
        # strategy sees current book TODO: stale by feed_us, needs book history
